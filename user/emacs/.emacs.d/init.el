...
(set-face-attribute 'mode-line nil :background "#33aaff" :foreground "#ffffff")
(set-face-attribute 'mode-line-buffer-id nil :background "#33aaff" :foreground "#080808")
(set-face-attribute 'minibuffer-prompt nil :foreground "#0077ff" :background "#afefff")
