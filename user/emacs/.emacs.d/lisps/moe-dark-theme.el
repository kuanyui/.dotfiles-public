...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   'moe-dark
   ;; Font lock faces
   `(font-lock-builtin-face              ((,class (:background unspecified :foreground ,moe-dark-builtin                  ))))
   `(font-lock-comment-delimiter-face    ((,class (:background unspecified :foreground ,moe-dark-comment-delimiter        :slant italic))))
   `(font-lock-comment-face              ((,class (:background unspecified :foreground ,moe-dark-comment                  :slant italic))))
   `(font-lock-constant-face             ((,class (:background unspecified :foreground ,moe-dark-constant                 ))))
   `(font-lock-doc-face                  ((,class (:background unspecified :foreground ,moe-dark-doc                      ))))
   `(font-lock-doc-string-face           ((,class (:background unspecified :foreground ,moe-dark-doc-string               ))))
   `(font-lock-function-name-face        ((,class (:background unspecified :foreground ,moe-dark-function-name            ))))
   `(font-lock-keyword-face              ((,class (:background unspecified :foreground ,moe-dark-keyword                  ))))
   `(font-lock-negation-char-face        ((,class (:background unspecified :foreground ,moe-dark-negation-char            ))))
   `(font-lock-preprocessor-face         ((,class (:background unspecified :foreground ,moe-dark-preprocessor             ))))
   `(font-lock-regexp-grouping-backslash ((,class (:background unspecified :foreground ,moe-dark-regexp-grouping-backslash))))
   `(font-lock-regexp-grouping-construct ((,class (:background unspecified :foreground ,moe-dark-regexp-grouping-construct))))
   `(font-lock-string-face               ((,class (:background unspecified :foreground ,moe-dark-string                   ))))
   `(font-lock-type-face                 ((,class (:background unspecified :foreground ,moe-dark-type                     ))))
   `(font-lock-variable-name-face        ((,class (:background unspecified :foreground ,moe-dark-variable-name            ))))
   `(font-lock-warning-face              ((,class (:background unspecified :foreground ,moe-dark-warning               :weight bold ))))
   ...
   `(org-agenda-structure ((,class (:foreground ,cyan-4 :background unspecified :bold t))))
   ...
   `(org-priority ((,class (:foreground ,red-1 :background unspecified))))
   `(org-block ((,class (:foreground ,blue-1 :background ,black-4))))
   `(org-block-background ((,class (:foreground unspecified :background ,black-4))))
   ...
   `(markdown-inline-code-face ((,class (:foreground ,white-0 :background ,black-2-5))))
   `(markdown-code-face ((,class (:foreground unspecified :background unspecified))))
   `(markdown-markup-face  ((,class (:foreground ,black-1 :background unspecified))))
   ...
   `(markdown-pre-face ((,class (:foreground ,white-0 :background ,black-2-5))))
   ...
   `(gnus-summary-high-ancient ((,class (:bold t :foreground ,red-3 :background unspecified))))
   `(gnus-summary-high-read ((,class (:bold t :foreground ,white-1))))
   `(gnus-summary-high-ticked ((,class (:slant italic :bold t :foreground ,red-2 :background unspecified))))
   `(gnus-summary-high-undownloaded ((,class (:slant italic :foreground ,red-2 :background unspecified))))
   ...
   `(helm-selection-line ((,class (:foreground unspecified :background ,yellow-4))))
   ...
   `(diredp-dir-name ((,class (:foreground ,blue-1 :background ,black-5 :bold t))))
   ...
   `(diredfl-dir-heading ((,class (:foreground ,black-5 :background ,green-2))))
   `(diredfl-dir-name ((,class (:foreground ,blue-1 :background ,black-5 :bold t))))
   ...
   `(diredfl-flag-mark ((,class (:foreground ,white-1 :background ,magenta-3 :bold t))))
   `(diredfl-flag-mark-line ((,class (:foreground ,black-5 :background ,magenta-1))))
   ...
   `(transient-argument ((,class (:foreground ,orange-2 :background ,black-3 :weight bold))))
   `(transient-inactive-argument ((,class (:foreground ,black-2 :background unspecified :weight bold))))
   `(transient-value ((,class (:foreground ,magenta-2 :background ,black-3 :weight bold))))
   `(transient-inactive-value ((,class (:foreground ,black-2 :background unspecified :weight bold))))
   `(transient-heading ((,class (:foreground ,green-1 :background unspecified :underline t))))
   `(transient-higher-level ((,class (:foreground ,white-0 :background unspecified :underline t))))
   `(transient-key ((,class (:foreground ,purple-1 :background unspecified :weight bold))))
   `(transient-key-exit ((,class (:foreground ,yellow-1 :background unspecified :weight bold))))
   ...
   `(transient-unreachable ((,class (:foreground ,black-1 :background unspecified :strike-through t))))
   `(transient-unreachable-key ((,class (:foreground ,black-1 :background unspecified :strike-through t))))
   `(transient-inapt-suffix ((,class (:foreground ,black-2-5 :background unspecified :strike-through t :slant italic))))
   `(transient-mismatched-key ((,class (:foreground unspecified :background unspecified :box (:line-width (1 . 1) :color ,magenta-2)))))
   ...
   `(magit-branch-current ((,class (:foreground ,white-0 :background ,orange-2 :bold t :underline t :box (:line-width (1 . 1) :color ,white-0)))))
   `(magit-branch-local ((,class (:foreground ,green-4 :background ,green-00 :bold t :underline nil))))
   `(magit-branch-remote ((,class (:foreground ,blue-3 :background ,blue-0 :bold t :underline nil))))
   `(magit-cherry-equivalent ((,class (:foreground ,purple-2))))
   `(magit-cherry-unmatched ((,class (:foreground ,cyan-4))))
   `(magit-diff-added ((,class (:foreground ,green-0 :background unspecified :bold t))))
   `(magit-diff-added-highlight ((,class (:foreground ,green-0 :bold t :inherit (magit-section-highlight)))))
   `(magit-diff-base ((,class (:foreground ,yellow-1 :background unspecified))))
   ...
   `(magit-diff-context ((,class (:foreground ,white-1 :background unspecified))))
   ...
   `(magit-log-author ((,class (:foreground ,green-2 :background unspecified))))
   ...
   `(magit-section-heading ((,class (:foreground ,orange-3 :background unspecified :bold t :underline t))))
   `(magit-section-heading-selection ((,class (:foreground ,white-0 :background ,blue-3))))
   `(magit-section-highlight ((,class (:background ,black-3 :foreground ,white-0))))
   ...
   `(magit-diff-add ((,class (:foreground ,green-0 :background unspecified :bold t))))
   `(magit-diff-del ((,class (:foreground ,red-0 :background unspecified :bold t))))
   ...
   `(magit-log-message ((,class (:foreground ,white-1 :background unspecified))))
   ...
   `(semantic-decoration-on-unparsed-includes      ((,class (:foreground unspecified      :background ,black-3))))
   `(semantic-highlight-edits-face                 ((,class (:foreground unspecified :background ,green-5))))
   `(semantic-highlight-func-current-tag-face      ((,class (:foreground unspecified :background ,green-5))))
   ...
   ;; Ace-jump
   `(ace-jump-face-background ((,class (:background unspecified :foreground ,black-2-5))))
   ...
   `(mmm-delimiter-face ((,class (:background unspecified :foreground ,white-0))))
   ...
   ;; Swoop
   `(swoop-face-header-format-line ((,class (:foreground ,black-6 :background unspecified :underline nil))))
   ...
   `(info-header-xref ((,class (:foreground ,blue-1 :background unspecified :bold t))))
   ...
   ;; Haskell
   `(haskell-interactive-face-compile-error ((,class (:foreground ,red-0 :background unspecified :bold t))))
   `(haskell-interactive-face-compile-warning ((,class (:foreground ,orange-2 :background unspecified :bold t))))
